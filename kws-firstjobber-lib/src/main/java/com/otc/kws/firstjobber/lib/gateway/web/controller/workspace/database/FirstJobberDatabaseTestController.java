...
@Controller
@RequestMapping(KwsFirstJobberWorkspaceController.PREFIX_PATH + "/database/test")
public class FirstJobberDatabaseTestController extends KwsFirstJobberWorkspaceController
{
	@Override
