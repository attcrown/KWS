...
@Controller
@RequestMapping(KwsFirstJobberWorkspaceController.PREFIX_PATH + "/database/skill-category")
public class FirstJobberDatabaseSkillCategoryController extends KwsFirstJobberWorkspaceController
{
	@Override
