...
@Controller
@RequestMapping(KwsFirstJobberWorkspaceController.PREFIX_PATH + "/employer/payment-history")
public class FirstJobberEmployerPaymentHistoryController extends KwsFirstJobberWorkspaceController
{
	@Override
