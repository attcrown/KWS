...
@Controller
@RequestMapping(KwsFirstJobberWorkspaceController.PREFIX_PATH + "/freelance/profile")
public class FirstJobberFreelanceProfileController extends KwsFirstJobberWorkspaceController
{
	@Override
