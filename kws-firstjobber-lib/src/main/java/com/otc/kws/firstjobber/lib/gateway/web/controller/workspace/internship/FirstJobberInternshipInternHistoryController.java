...
@Controller
@RequestMapping(KwsFirstJobberWorkspaceController.PREFIX_PATH + "/internship/intern-history")
public class FirstJobberInternshipInternHistoryController extends KwsFirstJobberWorkspaceController
{
	@Override
