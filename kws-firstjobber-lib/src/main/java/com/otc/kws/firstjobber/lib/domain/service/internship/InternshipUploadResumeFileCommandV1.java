...
@Component
public class InternshipUploadResumeFileCommandV1 extends InternshipUploadResumeFileCommand
{
	@Override
	public Response uploadResumeFile(Request request) 
	{
		FileStorePutFileCommand.Response putFileResponse = fileStoreService.putFile(req -> {
			...
			req.setFileGroup(FileStoreConst.FILE_GROUP_INTERNSHIP_RESUME);
			req.setVariables(variables);
			req.setFileData(request.getResumeFile());
		 });
