...
@Controller
@RequestMapping(KwsFirstJobberWorkspaceController.PREFIX_PATH + "/internship/skill")
public class FirstJobberInternshipSkillController extends KwsFirstJobberWorkspaceController
{
	@Override
