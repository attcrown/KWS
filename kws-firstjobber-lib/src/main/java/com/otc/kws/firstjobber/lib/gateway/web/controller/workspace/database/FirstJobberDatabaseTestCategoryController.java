...
@Controller
@RequestMapping(KwsFirstJobberWorkspaceController.PREFIX_PATH + "/database/test-category")
public class FirstJobberDatabaseTestCategoryController extends KwsFirstJobberWorkspaceController
{
	@Override
