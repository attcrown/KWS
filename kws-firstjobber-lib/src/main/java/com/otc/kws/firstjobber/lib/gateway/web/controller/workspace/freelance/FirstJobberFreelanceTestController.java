...
@Controller
@RequestMapping(KwsFirstJobberWorkspaceController.PREFIX_PATH + "/freelance/test")
public class FirstJobberFreelanceTestController extends KwsFirstJobberWorkspaceController
{
	@Override
