...
@Controller
@RequestMapping(KwsFirstJobberWorkspaceController.PREFIX_PATH + "/stats/line")
public class FirstJobberStatsLineController extends KwsFirstJobberWorkspaceController
{
	@Override
