...
@Controller
@RequestMapping(KwsFirstJobberWorkspaceController.PREFIX_PATH + "/report/dashboard")
public class FirstJobberReportDashboardController extends KwsFirstJobberWorkspaceController
{
	@Override
