...
@Component
public class InternshipUploadInformalPhotoCommandV1 extends InternshipUploadInformalPhotoCommand
{
	@Override
	public Response uploadInformalPhoto(Request request) 
	{
		FileStorePutFileCommand.Response putFileResponse = fileStoreService.putFile(req -> {
			...
			req.setFileGroup(FileStoreConst.FILE_GROUP_INTERNSHIP_INFORMAL_PHOTO);
			req.setVariables(variables);
			req.setFileData(request.getInformalPhotoFile());
		 });
