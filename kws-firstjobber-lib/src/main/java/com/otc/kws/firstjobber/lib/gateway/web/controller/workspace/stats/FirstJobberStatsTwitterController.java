...
@Controller
@RequestMapping(KwsFirstJobberWorkspaceController.PREFIX_PATH + "/stats/twitter")
public class FirstJobberStatsTwitterController extends KwsFirstJobberWorkspaceController
{
	@Override
