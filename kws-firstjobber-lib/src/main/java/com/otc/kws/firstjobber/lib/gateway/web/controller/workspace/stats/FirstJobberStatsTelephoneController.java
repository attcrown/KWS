...
@Controller
@RequestMapping(KwsFirstJobberWorkspaceController.PREFIX_PATH + "/stats/telephone")
public class FirstJobberStatsTelephoneController extends KwsFirstJobberWorkspaceController
{
	@Override
