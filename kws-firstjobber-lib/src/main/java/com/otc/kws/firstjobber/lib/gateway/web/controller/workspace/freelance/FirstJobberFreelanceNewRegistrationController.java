...
@Controller
@RequestMapping(KwsFirstJobberWorkspaceController.PREFIX_PATH + "/freelance/new-registration")
public class FirstJobberFreelanceNewRegistrationController extends KwsFirstJobberWorkspaceController
{
	@Override
