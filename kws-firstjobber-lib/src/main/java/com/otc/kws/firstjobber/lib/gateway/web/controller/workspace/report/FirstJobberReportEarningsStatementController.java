...
@Controller
@RequestMapping(KwsFirstJobberWorkspaceController.PREFIX_PATH + "/report/earnings-statement")
public class FirstJobberReportEarningsStatementController extends KwsFirstJobberWorkspaceController
{
	@Override
