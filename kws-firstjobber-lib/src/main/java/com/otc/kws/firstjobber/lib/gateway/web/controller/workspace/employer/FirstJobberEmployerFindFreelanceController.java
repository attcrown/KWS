...
@Controller
@RequestMapping(KwsFirstJobberWorkspaceController.PREFIX_PATH + "/employer/find-freelance")
public class FirstJobberEmployerFindFreelanceController extends KwsFirstJobberWorkspaceController
{
	@Override
