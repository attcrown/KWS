...
@Controller
@RequestMapping(KwsFirstJobberWorkspaceController.PREFIX_PATH + "/report/employer-payment")
public class FirstJobberReportEmployerPaymentController extends KwsFirstJobberWorkspaceController
{
	@Override
