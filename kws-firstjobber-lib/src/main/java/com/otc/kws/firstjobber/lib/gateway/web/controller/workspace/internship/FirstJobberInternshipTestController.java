...
@Controller
@RequestMapping(KwsFirstJobberWorkspaceController.PREFIX_PATH + "/internship/test")
public class FirstJobberInternshipTestController extends KwsFirstJobberWorkspaceController
{
	@Override
