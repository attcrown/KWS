...
@Component
public class FjbInternshipUploadHigh5TestImageCommandV1 extends FjbInternshipUploadHigh5TestImageCommand
{
	@Override
	public Response uploadHigh5TestImage(Request request) 
	{
		FileStorePutFileCommand.Response putFileResponse = fileStoreService.putFile(req -> {
			...
			req.setFileGroup(FileStoreConst.FILE_GROUP_TEST_HIGH5);
