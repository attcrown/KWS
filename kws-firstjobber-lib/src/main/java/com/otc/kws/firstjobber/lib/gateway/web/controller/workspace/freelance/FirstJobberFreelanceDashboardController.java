...
@Controller
@RequestMapping(KwsFirstJobberWorkspaceController.PREFIX_PATH + "/freelance/dashboard")
public class FirstJobberFreelanceDashboardController extends KwsFirstJobberWorkspaceController
{
	@Override
