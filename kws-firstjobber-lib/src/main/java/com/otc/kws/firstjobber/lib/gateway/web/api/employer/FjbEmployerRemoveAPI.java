...
@RestController
@RequestMapping(BaseKwsFirstJobberAPI.PREFIX_PATH + "/employer/remove")
public class FjbEmployerRemoveAPI extends BaseKwsFirstJobberAPI
{
	@Autowired
	...
	{
		logger.info("### FjbEmployerRemoveAPI.remove ###");
		logger.info("requestMessage => " + requestMessage);
		
		FjbEmployerProfile employerProfile = fjbEmployerService.removeEmployer(req -> {
