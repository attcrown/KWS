...
@Controller
@RequestMapping(KwsFirstJobberWorkspaceController.PREFIX_PATH + "/freelance/evaluate")
public class FirstJobberFreelanceEvaluateController extends KwsFirstJobberWorkspaceController
{
	@Override
