...
@Controller
@RequestMapping(KwsFirstJobberWorkspaceController.PREFIX_PATH + "/report/expense")
public class FirstJobberReportExpenseController extends KwsFirstJobberWorkspaceController
{
	@Override
