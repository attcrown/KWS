...
@Controller
@RequestMapping(KwsFirstJobberWorkspaceController.PREFIX_PATH + "/employer/find-internship")
public class FirstJobberEmployerFindInternshipController extends KwsFirstJobberWorkspaceController
{
	@Override
