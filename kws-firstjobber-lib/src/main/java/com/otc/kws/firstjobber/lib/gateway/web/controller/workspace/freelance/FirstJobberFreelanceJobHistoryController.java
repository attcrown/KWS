...
@Controller
@RequestMapping(KwsFirstJobberWorkspaceController.PREFIX_PATH + "/freelance/job-history")
public class FirstJobberFreelanceJobHistoryController extends KwsFirstJobberWorkspaceController
{
	@Override
