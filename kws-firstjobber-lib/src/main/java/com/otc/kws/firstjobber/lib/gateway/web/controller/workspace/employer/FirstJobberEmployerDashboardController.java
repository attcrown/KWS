...
@Controller
@RequestMapping(KwsFirstJobberWorkspaceController.PREFIX_PATH + "/employer/dashboard")
public class FirstJobberEmployerDashboardController extends KwsFirstJobberWorkspaceController
{
	@Override
