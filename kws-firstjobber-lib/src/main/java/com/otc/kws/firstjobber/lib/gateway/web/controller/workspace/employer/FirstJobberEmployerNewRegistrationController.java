...
@Controller
@RequestMapping(KwsFirstJobberWorkspaceController.PREFIX_PATH + "/employer/new-registration")
public class FirstJobberEmployerNewRegistrationController extends KwsFirstJobberWorkspaceController
{
	@Override
