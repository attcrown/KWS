...
@Controller
@RequestMapping(KwsFirstJobberWorkspaceController.PREFIX_PATH + "/internship/evaluate")
public class FirstJobberInternshipEvaluateController extends KwsFirstJobberWorkspaceController
{
	@Override
