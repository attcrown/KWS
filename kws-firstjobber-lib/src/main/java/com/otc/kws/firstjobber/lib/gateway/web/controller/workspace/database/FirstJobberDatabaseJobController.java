...
@Controller
@RequestMapping(KwsFirstJobberWorkspaceController.PREFIX_PATH + "/database/job")
public class FirstJobberDatabaseJobController extends KwsFirstJobberWorkspaceController
{
	@Override
