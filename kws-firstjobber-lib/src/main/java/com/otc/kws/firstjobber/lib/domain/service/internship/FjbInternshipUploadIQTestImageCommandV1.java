...
@Component
public class FjbInternshipUploadIQTestImageCommandV1 extends FjbInternshipUploadIQTestImageCommand
{
	@Override
	public Response uploadIQTestImage(Request request) 
	{
		FileStorePutFileCommand.Response putFileResponse = fileStoreService.putFile(req -> {
			...
			req.setFileGroup(FileStoreConst.FILE_GROUP_TEST_IQ);
