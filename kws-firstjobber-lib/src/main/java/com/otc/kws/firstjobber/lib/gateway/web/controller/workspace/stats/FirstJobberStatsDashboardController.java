...
@Controller
@RequestMapping(KwsFirstJobberWorkspaceController.PREFIX_PATH + "/stats/dashboard")
public class FirstJobberStatsDashboardController extends KwsFirstJobberWorkspaceController
{
	@Override
