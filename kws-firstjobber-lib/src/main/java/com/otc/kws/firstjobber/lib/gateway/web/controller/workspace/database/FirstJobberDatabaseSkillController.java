...
@Controller
@RequestMapping(KwsFirstJobberWorkspaceController.PREFIX_PATH + "/database/skill")
public class FirstJobberDatabaseSkillController extends KwsFirstJobberWorkspaceController
{
	@Override
