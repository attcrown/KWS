...
@RestController
@RequestMapping(BaseKwsFishsixAPI.PREFIX_PATH + "/subject/update")
public class FishsixSubjectUpdateAPI extends BaseKwsFishsixAPI
{
	@Autowired
	...
	@PostMapping
	public ResponseEntity<?> updateSubject(HttpServletRequest request, @ModelAttribute RequestMessage requestMessage) throws Exception
	{
		...
		SubjectProfile updatedSubjectProfile = subjectService.updateSubject(req -> {
		...
		}).getUpdatedSubjectProfile();
		
		BodyResponseMessage bodyResponseMessage = new BodyResponseMessage();
		bodyResponseMessage.setUpdatedSubjectProfile(updatedSubjectProfile);
