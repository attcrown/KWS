...
@Controller
@RequestMapping(KwsFishsixWorkspaceController.PREFIX_PATH + "/admin/salesman/customer-follow")
public class FishsixSalesmanCustomerFollowController extends KwsFishsixWorkspaceController
{
	@Override
