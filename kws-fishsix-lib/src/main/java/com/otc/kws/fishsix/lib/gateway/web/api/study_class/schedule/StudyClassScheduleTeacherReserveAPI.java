...
@RestController
@RequestMapping(BaseKwsFishsixAPI.PREFIX_PATH + "/study-class/schedule/teacher-reserve")
public class StudyClassScheduleTeacherReserveAPI extends BaseKwsFishsixAPI
{
	@Autowired
	...
	@PostMapping
	public ResponseEntity<?> teacherReserve(HttpServletRequest request, @RequestBody RequestMessage requestMessage)
	{
		logger.info("### {}.teacherReserve ###", getClass().getSimpleName());
