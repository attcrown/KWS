...
@RestController
@RequestMapping(BaseKwsFishsixAPI.PREFIX_PATH + "/student/create")
public class FishsixStudentCreateAPI extends BaseKwsFishsixAPI
{
	@Autowired
	...
	@PostMapping
	public ResponseEntity<?> createStudent(HttpServletRequest request, @RequestBody(required = false) RequestMessage requestMessage)
	{
