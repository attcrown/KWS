...
@RestController
@RequestMapping(BaseKwsFishsixAPI.PREFIX_PATH + "/subject/chapter/media/update")
public class FishsixSubjectChapterMediaUpdateAPI extends BaseKwsFishsixAPI
{
	@Autowired
	...
	@PostMapping
	public ResponseEntity<?> updateSubjectChapterMedia(HttpServletRequest request, @ModelAttribute RequestMessage requestMessage) throws Exception
	{
		...
		SubjectProfile.SubjectChapterMedia updatedSubjectChapterMedia = subjectService.updateSubjectChapterMedia(req -> {
		...
		}).getUpdatedSubjectChapterMedia();
		
		BodyResponseMessage bodyResponseMessage = new BodyResponseMessage();
		bodyResponseMessage.setUpdatedSubjectChapterMedia(updatedSubjectChapterMedia);
