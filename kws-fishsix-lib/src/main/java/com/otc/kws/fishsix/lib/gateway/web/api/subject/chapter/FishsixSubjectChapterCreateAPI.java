...
@RestController
@RequestMapping(BaseKwsFishsixAPI.PREFIX_PATH + "/subject/chapter/create")
public class FishsixSubjectChapterCreateAPI extends BaseKwsFishsixAPI
{
	@Autowired
	...
	@PostMapping
	public ResponseEntity<?> createSubjectChapter(HttpServletRequest request, @ModelAttribute RequestMessage requestMessage) throws Exception
	{
		...
		SubjectProfile.SubjectChapter createdSubjectChapter = subjectService.createSubjectChapter(req -> {
		...
		}).getCreatedSubjectChapter();
		
		BodyResponseMessage bodyResponseMessage = new BodyResponseMessage();
		bodyResponseMessage.setCreatedSubjectChapter(createdSubjectChapter);
