...
@Controller
@RequestMapping(KwsFishsixWorkspaceController.PREFIX_PATH + "/admin/salesman/profile")
public class FishsixSalesmanProfileController extends KwsFishsixWorkspaceController
{
	@Override
