...
@Component
public class StudyClassEvaluationApproveCommand extends BaseStudyClassEvaluationCommand
{
	@Autowired
	...
	public Response approveStudyClassEvaluation(Request request)
	{
		...
		setTeacherHourAcquired(request, EvaluationOperation.APPROVE, evaluation);
