...
@Entity
@Table(name = "mkp_product_stock")
@Data
public class MkpProductStock extends BaseKwsMarketPetEntity
{
	@Id
	@Column(name = "id")
	protected String id;
	...
	protected Date effectedAt;
	
	@Column(name = "import_volume")
	protected int importVolume;
	
	@Column(name = "balance_volume")
	protected int balanceVolume;
