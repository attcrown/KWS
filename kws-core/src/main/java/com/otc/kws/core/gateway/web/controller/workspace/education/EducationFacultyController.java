...
@Controller
@RequestMapping(KwsCoreWorkspaceController.PREFIX_PATH + "/education/education-faculty")
public class EducationFacultyController extends KwsCoreWorkspaceController
{
	@Override
